...
var useReqHeader = process.env.TS_USE_REQ_HEADER.toLowerCase() === 'true';
...
wss.on('connection', function (ws) {
  if (!authenticate(ws.upgradeReq.headers)) {
    ...
    (0, _libNetworkRegistry.websocket)(ws, tunnelWebsocketPath, tunnelWebsocketProtocol, useReqHeader);
  }
});
...
(0, _libLog.log)('TS_TUNNEL_PORT: ' + useReqHeader);
